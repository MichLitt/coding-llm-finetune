...
# Known HumanEval function names — any SFT sample referencing these is suspicious
HUMANEVAL_SIGNATURES = {
    ...
    "string_xor", "longest", "greatest_common_divisor", "all_prefixes",
    "string_sequence", "count_distinct_characters", "parse_music",
    "how_many_times", "sort_numbers", "find_closest_elements", "rescale_to_unit",
    "filter_integers", "strlen", "large_prime", "fibfib", "vowels_count",
    "circular_shift", "digitSum", "fruit_distribution", "pluck", "search",
    ...
    "prime_length", "starts_one_ends", "solve", "anti_shuffle", "get_row",
    "sort_array", "encrypt", "next_smallest", "is_bored", "any_int",
    "encode", "skjkasdkd", "check_dict_case", "count_up_to", "multiply",
    "count_upper", "closest_integer", "make_a_pile", "words_string",
    "choose_num", "rounded_avg", "unique_digits", "by_length", "even_odd_count",
    "int_to_mini_roman", "right_angle_triangle", "find_max", "eat", "do_algebra",
    "string_to_md5", "generate_integers",
    # targeted cases
    "same_chars", "fib", "minSubArraySum", "intersection", "prod_signs",
    "tri", "file_name_check", "get_max_triples",
}
    ...
    if sig_hits:
        ...
        if verbose:
            for idx, sig, snippet in sig_hits[:10]:
                print(f"  Sample {idx}: matched '{sig}' — {snippet!r}")
